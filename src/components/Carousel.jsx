                            ...
                            <div className="max-w-7xl mx-auto px-6 w-full">
                                <div className="max-w-4xl text-white">
                                    <div className="overflow-hidden">
                                        <p className={`text-lg font-medium mb-4 text-red-400 tracking-wider transform transition-all duration-1000 delay-300 ${index === currentSlide ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                                            }`}>
                                            {slide.subtitle}
                                        </p>
                                    </div>
                                    ...
                                    <div className="overflow-hidden">
                                        <h1 className={`text-5xl md:text-7xl font-bold mb-6 leading-tight transform transition-all duration-1000 delay-500 ${index === currentSlide ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
                                            }`}>
                                            {slide.title}
                                        </h1>
                                    </div>
                                    ...
                                    <div className="overflow-hidden">
                                        <p className={`text-xl mb-8 leading-relaxed max-w-2xl text-gray-100 transform transition-all duration-1000 delay-700 ${index === currentSlide ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                                            }`}>
                                            {slide.description}
                                        </p>
                                    </div>
                                    ...
                                    <div className="overflow-hidden">
                                        <button className={`bg-red-500 hover:bg-red-600 text-white px-8 py-4 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-2xl border border-red-400/20 ${index === currentSlide ? 'translate-y-0 opacity-100 delay-1000' : 'translate-y-8 opacity-0'
                                            }`}>
                                            {slide.buttonText}
                                        </button>
                                    </div>
